    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('slider.list')}}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="" name="editSlider" id="editSlider" method="POST">
            <div class="card">
                <div class="card-body">								
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="image" value="{{$slider->image}}" type="file" id="formFile">
                              </div>
                              <p>current image</p>
                              <img class="img-fluid" height="200" width="200" src="{{env('APP_URL').'/images/slider/'.$slider->image}}" alt="">
...
@section('customJs')
<script>
    $('#editSlider').submit(function(event){
