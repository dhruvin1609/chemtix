    ...
    <div class="container-fluid">
        <form action="" name="editService" id="editService" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p>current image</p>
                                <img class="img-fluid" height="200" width="200" src="{{env('APP_URL').'/images/our_service/'.$service->image}}" alt="">
                                <p></p>
                              </div>
                        </div>					
                    </div>
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{route('service.list')}}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
