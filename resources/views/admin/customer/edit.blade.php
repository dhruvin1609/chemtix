                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="customer_name" id="customer_name" value="{{$customer->customer_name}}" class="form-control" placeholder="Supplier Name">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="customer_type" id="customer_type" class="select2 form-control">
                                    <option {{$customer->customer_type == 'manufacturers' ? 'selected' : ''}} value="manufacturers">Manufacturers</option>
                                    <option {{$customer->customer_type == 'formulation' ? 'selected' : ''}} value="formulation">Formulation</option>
                                    <option {{$customer->customer_type == 'supplier' ? 'selected' : ''}} value="supplier">Supplier</option>
                                    <option {{$customer->customer_type == 'import_export_company' ? 'selected' : ''}} value="import_export_company">IMPORT & EXPORT company</option>
                                    <option {{$customer->customer_type == 'trading_company' ? 'selected' : ''}} value="trading_company">Trading Company</option>
                                </select>
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_city" id="customer_city" value="{{$customer->customer_city}}" class="form-control" placeholder="City">
                                <p></p>
                            </div>
                        </div>    
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="customer_address" id="customer_address" class="form-control" cols="30" rows="10" placeholder="Address">{{$customer->customer_address}}</textarea>
                                <p></p>
                            </div>
                        </div>   
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_state" value="{{$customer->customer_state}}" id="customer_state" class="form-control" placeholder="State">
                                <p></p>
                            </div>
                            <div class="mb-3">
                                <label for="customer_country">Country</label>
                                <input name="customer_country" value="{{$customer->customer_country}}" id="customer_country" class="form-control" placeholder="Country">
                                <p></p>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_fax" value="{{$customer->customer_fax}}" id="customer_fax" class="form-control" placeholder="Fax Number">
                                <p></p>
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_email" value="{{$customer->customer_email}}" id="customer_email" class="form-control" placeholder="Email">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_website" value="{{$customer->customer_website}}" id="customer_website" class="form-control" placeholder="Website">
                                <p></p>
                            </div>
                        </div>  
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_gst_no" value="{{$customer->customer_gst_no}}" id="customer_gst_no" class="form-control" placeholder="GST Number">
                                <p></p>
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_msme" value="{{$customer->customer_msme}}" id="customer_msme" class="form-control" placeholder="MSME">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="customer_pan_no" value="{{$customer->customer_pan_no}}" id="customer_pan_no" class="form-control" placeholder="PAN Number">
                                <p></p>
                            </div>
                ...
                <div class="card-body">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact_name" value="{{$customer->contact_name}}" id="contact_name" class="form-control" placeholder="Name">	
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact_phone" value="{{$customer->contact_phone}}" id="contact_phone" class="form-control" placeholder="Phone Number">	
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact_designation" value="{{$customer->contact_designation}}" id="contact_designation" class="form-control" placeholder="Designation">	
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact_email" value="{{$customer->contact_email}}" id="contact_email" class="form-control" placeholder="Email">	
                            <p></p>
                        </div>
                    </div>
                </div>
